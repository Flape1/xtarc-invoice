...
function SettingsDrawer({ inv, set, allCurrencies, onAddCurrency, onClose, onSaveDefaultSig }) {
  ...
  return (
    <div style={{position:"fixed",top:0,right:0,bottom:0,width:"296px",background:C.white,
...
function TemplatesModal({ inv, onLoad, onClose }) {
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.2)",zIndex:600,
      ...
      <div style={{background:C.white,borderRadius:"14px",width:"480px",maxHeight:"80vh",
      ...
      <div style={{minHeight:"100vh",background:C.gray100}}>
        ...
        <div style={{height:"50px",background:C.white,borderBottom:`1px solid ${C.gray200}`,
          ...
          <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
            ...
            <button onClick={()=>setShowTemplates(true)} style={{...GBS("outline"),fontSize:"12px"}}>📋 Templates</button>
            <button onClick={()=>setShowSettings(s=>!s)} style={{...GBS(showSettings?"dark":"outline"),fontSize:"12px"}}>⚙ Settings</button>
        ...
        <div style={{padding:"32px 24px",display:"flex",justifyContent:"center"}}>
          <div style={{transform:"scale(0.88)",transformOrigin:"top center",width:"794px",marginBottom:"60px"}}>
